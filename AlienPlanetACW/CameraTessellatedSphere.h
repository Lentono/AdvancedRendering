...
{
	class CameraTessellatedSphere
	{
	public:
		CameraTessellatedSphere(const std::shared_ptr<DX::DeviceResources>& deviceResources, const std::shared_ptr<ResourceManager>& resourceManager);
